...
public class LinkedSeq<E> implements Cloneable
{
   ...
   **/
   ...
   {
	     if (cursor != null) {
	    	 precursor = new Node<E>(element, head);
	    	 cursor = precursor;
	     }
	     else if (cursor == null) {
	    	 head = new Node<E>(element, head);
   ...
   **/
   public void addAll(LinkedSeq<E> addend)
   {
	     ...
	     if (addend.manyNodes > 0 || addend != null) {
	    	 addend.head.setLink(tail);
	    	 tail = addend.tail;
   ...
   **/ 
   ...
   {   LinkedSeq<E> answer;
	   ...
	   try
	   {
		   answer = (LinkedSeq<E>) super.clone( ); // causes warning; ignore it
	   }
   ...
   **/   
   ...
   {
	   LinkedSeq<E> total = new LinkedSeq<E>();
